...
class Entity(models.Model):
    ...
    related_entities = models.ManyToManyField('self', verbose_name=u'Related Entities')
...
class EntityField(models.Model):
    ...
    size = models.PostiveInteger(u'Size')
    ...
    def __unicode__(self):
        return u"%s %s(%d) | %s" % (self.name, self.type, self.size, self.print_is_null)
